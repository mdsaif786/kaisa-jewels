    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.addresses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alternate_phone') ? 'is-invalid' : '' }}" type="text" name="alternate_phone" id="alternate_phone" value="{{ old('alternate_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pincode') ? 'is-invalid' : '' }}" type="number" name="pincode" id="pincode" value="{{ old('pincode', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('additional_note') ? 'is-invalid' : '' }}" type="text" name="additional_note" id="additional_note" value="{{ old('additional_note', '') }}">
