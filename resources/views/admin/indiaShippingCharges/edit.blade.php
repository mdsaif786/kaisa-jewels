...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.indiaShippingCharge.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.india-shipping-charges.update", [$indiaShippingCharge->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="pincode">{{ trans('cruds.indiaShippingCharge.fields.pincode') }}</label>
                <input class="form-control {{ $errors->has('pincode') ? 'is-invalid' : '' }}" type="text" name="pincode" id="pincode" value="{{ old('pincode', $indiaShippingCharge->pincode) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('circle_name') ? 'is-invalid' : '' }}" type="text" name="circle_name" id="circle_name" value="{{ old('circle_name', $indiaShippingCharge->circle_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('taluk') ? 'is-invalid' : '' }}" type="text" name="taluk" id="taluk" value="{{ old('taluk', $indiaShippingCharge->taluk) }}">
                @if($errors->has('taluk'))
                    <div class="invalid-feedback">
                        {{ $errors->first('taluk') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_name') ? 'is-invalid' : '' }}" type="text" name="office_name" id="office_name" value="{{ old('office_name', $indiaShippingCharge->office_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('district_name') ? 'is-invalid' : '' }}" type="text" name="district_name" id="district_name" value="{{ old('district_name', $indiaShippingCharge->district_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('region_name') ? 'is-invalid' : '' }}" type="text" name="region_name" id="region_name" value="{{ old('region_name', $indiaShippingCharge->region_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hq_rate_per_kg') ? 'is-invalid' : '' }}" type="text" name="hq_rate_per_kg" id="hq_rate_per_kg" value="{{ old('hq_rate_per_kg', $indiaShippingCharge->hq_rate_per_kg) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_rate') ? 'is-invalid' : '' }}" type="text" name="other_rate" id="other_rate" value="{{ old('other_rate', $indiaShippingCharge->other_rate) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cod_rate') ? 'is-invalid' : '' }}" type="text" name="cod_rate" id="cod_rate" value="{{ old('cod_rate', $indiaShippingCharge->cod_rate) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_amount') ? 'is-invalid' : '' }}" type="text" name="total_amount" id="total_amount" value="{{ old('total_amount', $indiaShippingCharge->total_amount) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\IndiaShippingCharge::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $indiaShippingCharge->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
