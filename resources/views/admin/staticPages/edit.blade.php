    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.static-pages.update", [$staticPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('static_page_type') ? 'is-invalid' : '' }}" name="static_page_type_id" id="static_page_type_id" required>
                    @foreach($static_page_types as $id => $static_page_type)
                        <option value="{{ $id }}" {{ (old('static_page_type_id') ? old('static_page_type_id') : $staticPage->static_page_type->id ?? '') == $id ? 'selected' : '' }}>{{ $static_page_type }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('page_name') ? 'is-invalid' : '' }}" type="text" name="page_name" id="page_name" value="{{ old('page_name', $staticPage->page_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('page_title') ? 'is-invalid' : '' }}" type="text" name="page_title" id="page_title" value="{{ old('page_title', $staticPage->page_title) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('page_description') ? 'is-invalid' : '' }}" name="page_description" id="page_description">{{ old('page_description', $staticPage->page_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_keywords') ? 'is-invalid' : '' }}" type="text" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords', $staticPage->meta_keywords) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', $staticPage->meta_description) }}">
