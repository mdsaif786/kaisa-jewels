			...
			<div class="row">
				<div class="col-xs-12">
					<ul class="scrollSpyTabNav inline">
						<li><a class="scrollSpyLink active details_curriculum" href="#details_curriculum">Curriculum</a></li>
			...
			<div class="row">
				<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12 voffset3">
										<div class="ccwrapDisp">
											...
											<article>
												<ul class="courseHeadWrap">
													<li>Engaging and Motivating Students + Evaluation Strategies</li>
													<li>4 videos, 6 quizzes</li>
													<li>2:40:30</li>
													<li><button>Buy now</button></li>
												</ul>
												<div class="ccDetailWrap">
													<ul class="items">
														<li>Key Concept - Engaging and Motivating Students</li>
														<li>4:15</li>
														<li><button>Preview</button></li>
													</ul>
													<ul class="items">
														<li>Case Study - Online Teamwork and Collaboration</li>
														<li>7:30</li>
														<li><button>Preview</button></li>
													</ul>
													<ul class="items">
														<li>Key Concept - Evaluation Strategies</li>
														<li>20:30</li>
														<li><button>Preview</button></li>
													</ul>
													<ul class="items">
														<li>Learning Analytics to Inform Teaching Practice</li>
														<li>25:30</li>
														<li><button>Preview</button></li>
													</ul>
													<ul class="items">
														<li>How to Get the Most from the Assignment</li>
														<li>25:30</li>
														<li><button>Preview</button></li>
													</ul>
													<ul class="items">
														<li>Module 7 Useful Links and Resources</li>
														<li>25:30</li>
														<li><button>Preview</button></li>
													</ul>
												</div>
					...
					<section class="scrollCntWrap" id="details_fees">
						<div class="row">
							<div class="col-xs-12">
								<h4 class="bold">Fees</h4>
								<h4 class="greenTxt bold voffset2"><i>₹</i>25,500</h4>
								<h6>
									<small>(Inclusive of all taxes)</small>
									<small class="strickOut"><i>₹</i>35,500</small>
									<small>33% off</small>
