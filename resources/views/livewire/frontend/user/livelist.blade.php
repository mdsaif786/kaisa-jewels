				...
				<div class="row">
					...
					<div class="col-xs-12 voffset2">
						<div class="fullFlexList">
							@if(!empty($user_live_classes))
							@foreach($user_live_classes as $course)
							<article>								
								<div class="row">
									...
									<div class="col-xs-12 col-sm-6 col-md-4 voffset3">
										...
										<h6>
									    {{$course->live_class_lessons_count ?? ''}}
										</h6>
									</div>
									<div class="col-xs-12 col-sm-6 col-md-4 voffset3">
									...
									<div class="col-xs-12 voffset3">
										<div class="btnsWrap">
											<a href="{{ url('/user/livedetail/'.$course->slug) }}" class="smallBtnLink text-uppercase greenTxt">View course details</a>
										</div>
									</div>								
								</div>
							</article>
