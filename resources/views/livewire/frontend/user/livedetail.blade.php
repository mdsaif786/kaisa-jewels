	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 voffset3">
				<div class="row">
					<div class="col-xs-12 voffset2">
						<h3>{{$user_live_detail->class_name}}</h3>
					</div>
					<div class="col-xs-12 voffset2">
						...
						<div class="videoListWrap">
							...
							<div class="courseListing">
								<div class="playlistWrap">
									@if(!empty($user_live_detail->live_class_section))
									@foreach($user_live_detail->live_class_section as $key=> $section)
									<div class="chapterVidSecWrap">
									    ...
									    @endif
											...
											<h6>{{$section->live_class_lessons->count()}} videos</h6>
										</div>
										@if(!empty($section->live_class_lessons))
										@foreach($section->live_class_lessons as $key=>$lesson)
