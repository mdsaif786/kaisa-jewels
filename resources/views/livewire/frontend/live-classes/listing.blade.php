            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 voffset3">
                        ...
                        <h6 class="voffset1"><small>10 results found</small></h6>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 voffset3">
                                ...
                                @foreach($books as $key=>$book)
                                    <div class="col6">
                                        <article>
                                            ...
                                            <a href="#" class="titleLink">{{$book->name}}</a>
                                            <div class="priceAttr">
                                                <div>
                                                    <span class="stickOut">
                                                        <i class="currency_item">$</i>{{$book->mrp}}
                                                    </span>
                                                    <span><i class="currency_item">$</i>{{$book->price}}</span>
                                                </div>
