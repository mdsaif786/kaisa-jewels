...
<section class="topFirst">
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<ol class="breadcrumb">
				  <li><a href="{{URL::to('/listing')}}">Home</a></li>
						...
						<div class="col-xs-12">
							<div class="row">
								...
								<div class="col-xs-12">
									...
									<div class="priceAttr">
				                        <div>
				                            <span class="stickOut"><i class="currency_item">₹</i>{{$book->mrp}}</span>
				                            <span class="hlgt"><i class="currency_item">₹</i>{{$book->price}}</span>
				                        </div>
				                        <div>You Save: <i class="currency_item">₹</i>{{$book->mrp-$book->price}} ({{$book->discount}}%)</div>
				                    </div>
								...
								<div class="col-xs-12 voffset3">
									...
									<ul class="bulletList">
										...
										<li>Coupon code: <span class="bold text-uppercase">STHULA400</span></li>
									</ul>
									<hr/>
								</div>
								<div class="col-xs-12 voffset3">
					...
					<section class="scrollCntWrap" id="details_reviews">
						<div class="row">
							...
							<div class="col-xs-12 voffset2 reviewList">
			                	@if(!empty($live_class->live_class_reviews))
			                	@foreach($live_class->live_class_reviews as $key=>$review)
			                    <article>
			                        <div class="infoWrap">
			                            <h6 class="bold"> {{ $review->user->name ?? '' }}</h6>
			                            <h6 class="grayTxt"><small>MBA Program, 2019</small> | <small>{{$review->user->address->city}}</small></h6>
			                        ...
			                        <div class="infoBtmWrap">
			                            <span class="starRatings">
			                                <u class="orangeTxt bold">{{$review->review_point ?? ''}}</u>
                    ...
                    @if (!empty($relatedBooks))
                        @foreach ($relatedBooks as $relatedBook)
                            <article>
                                ...
                                <a href="#" class="titleLink">{{$relatedBook->name}}</a>
                                <div class="priceAttr">
                                    <div>
                                        <span class="stickOut"><i class="currency_item">$</i>{{$relatedBook->mrp}}</span>
                                        <span><i class="currency_item">$</i>{{$relatedBook->price}}</span>
                                    </div>
