...
class CountriesController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('shipping_allow', function ($row) {
                return $row->shipping_allow ? Country::SHIPPING_ALLOW_SELECT[$row->shipping_allow] : '';
            });
            $table->editColumn('shipping_charge', function ($row) {
                return $row->shipping_charge ? $row->shipping_charge : "";
            });
